    ...
    try:
        ...
        if detection_results is not None:
            ...
            if seating_layout:
                ...
                # === Save processed layout to Supabase (simplified schema with json_data) ===
                try:
                    ...
                    # Prepare data using simplified schema (matching push_requests table structure)
                    json_data = {
                        "uuid": unique_id,
                        "record_id": payload.record_id,
                        "layout_data": seating_layout,
                        "source": "webhook_new_data",
                        "processed_at": datetime.utcnow().isoformat()
                    }
                    
                    # Wrap in json_data field for simplified schema
                    processed_record = {
                        "json_data": json_data
